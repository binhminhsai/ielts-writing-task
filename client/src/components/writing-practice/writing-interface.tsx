...
import {
  getPhrases,
  getStructuredPhrases,
  phraseCategories,
} from "@/data/phrases";
import { WritingTestType, DifficultyLevel } from "./test-setup";
import { Link } from "wouter";
import { ShimmerCard } from "../ui/shimmer-loader";
    ...
    const fetchData = async () => {
      ...
      try {
        ...
        const response = await fetch(
          `${import.meta.env.VITE_API_BASE_URL}/writing-assistant`,
          {
            method: "POST",
            headers: {
                    ...
                    <AccordionContent className="p-3 bg-white">
                      <div className="space-y-3">
                        <div className="p-3 bg-[#f9fafb] rounded-md border border-gray-100 text-xs mb-3">
                          <p className="mb-2 font-medium text-[#1fb2aa]">
                            Dàn ý tổng quan
                          </p>
                          <p className="mb-2 text-[#374151]">
                            {apiData?.suggest_outline?.["1_dan_y_tong_quan"]
                              ?.mo_ta ||
                              "This is a Two-part question essay. The essay requires an analysis of the reasons behind the increasing trend of career changes and an evaluation of whether this is a positive or negative development for society."}
                          </p>
                        </div>
                      </div>
                    </AccordionContent>
                    ...
                    >
                      ...
                      <AccordionContent className="p-3 bg-white">
                        {index === 0 && (
                          <div className="mt-3 space-y-3">
                            <div className="p-3 bg-[#f9fafb] rounded-md border border-gray-100 text-xs">
                              ...
                              <p className="mb-2 text-[#374151]">
                                {apiData?.suggest_outline?.["2_introduction"]
                                  ?.huong_dan ||
                                  "Mở bài 2 câu – paraphrase đề + thesis statement"}
                              </p>
                            </div>
                            ...
                            <div className="p-3 rounded-md border border-blue-100 text-xs text-blue-700 bg-[#f9fafb]">
                              ...
                              <p className="mb-2 text-[#374151]">
                                ...
                                {apiData?.suggest_outline?.["2_introduction"]
                                  ?.cau_1_paraphrase?.muc_dich || "loading"}
                              </p>
                              <p className="mb-2 text-[#374151]">
                                • <strong>Ví dụ:</strong> "
                                {apiData?.suggest_outline?.["2_introduction"]
                                  ?.cau_1_paraphrase?.vi_du ||
                                  "The phenomenon of individuals frequently transitioning between different professions throughout their working lives is becoming increasingly common."}
                                "
                              </p>
                            </div>
                            ...
                            <div className="p-3 rounded-md border border-green-100 text-xs text-green-700 bg-[#f9fafb]">
                              ...
                              <p className="mb-2 text-[#374151]">
                                • <strong>Mục đích:</strong>{" "}
                                {apiData?.suggest_outline?.["2_introduction"]
                                  ?.cau_2_thesis?.muc_dich ||
                                  "Thesis statement phù hợp với Two-part question essay"}
                              </p>
                              <p className="mb-2 text-[#374151]">
                                • <strong>Ví dụ:</strong> "
                                {apiData?.suggest_outline?.["2_introduction"]
                                  ?.cau_2_thesis?.vi_du ||
                                  "This essay will explore the primary reasons behind this trend and argue that it represents a largely positive development for society."}
                                "
                              </p>
                            </div>
                          </div>
                        ...
                        {index === 1 && (
                          <div className="mt-3 space-y-3">
                            <div className="p-3 rounded-md border border-blue-100 text-xs text-blue-700 bg-[#f9fafb]">
                              <p className="mb-2 text-[#1fb2aa] font-medium">
                                Topic Sentence
                              </p>
                              <p className="mb-2 text-[#374151]">
                                • <strong>Content:</strong>{" "}
                                {apiData?.suggest_outline?.["3_body_1_causes"]
                                  ?.topic_sentence?.content || "loading"}
                              </p>
                              <p className="mb-2 text-[#374151]">
                                • <strong>Ví dụ:</strong>{" "}
                                {apiData?.suggest_outline?.["3_body_1_causes"]
                                  ?.topic_sentence?.vi_du ||
                                  "Several core factors compel individuals to alter their career paths in the contemporary era, ranging from technological advancements to evolving personal needs."}
                              </p>
                            </div>
                            ...
                            <div className="p-3 rounded-md border border-green-100 text-xs text-green-700 bg-[#f9fafb]">
                              ...
                              <p className="mb-2 text-[#374151]">
                                • <strong>Idea:</strong>{" "}
                                {apiData?.suggest_outline?.["3_body_1_causes"]
                                  ?.supporting_idea_1?.chu_de ||
                                  "Technological advancements and automation leading to job displacement or creation of new roles."}
                              </p>
                              <p className="mb-2 text-[#374151]">
                                • <strong>Ví dụ cụ thể:</strong>{" "}
                                {apiData?.suggest_outline?.["3_body_1_causes"]
                                  ?.supporting_idea_1?.vi_du_cu_the ||
                                  "For instance, the rise of AI and robotics has rendered many traditional manufacturing or administrative roles obsolete, forcing workers to retrain for new fields like data science or digital marketing."}
                              </p>
                              <p className="mb-2 text-[#374151]">
                                • <strong>Development:</strong>{" "}
                                {apiData?.suggest_outline?.["3_body_1_causes"]
                                  ?.supporting_idea_1?.development ||
                                  "Consequently, individuals must adapt by acquiring new skills or seeking opportunities in burgeoning sectors, leading to career shifts."}
                              </p>
                            </div>
                            ...
                            <div className="p-3 rounded-md border border-purple-100 text-xs text-purple-700 bg-[#f9fafb]">
                              ...
                              <p className="mb-2 text-[#374151]">
                                • <strong>Idea:</strong>{" "}
                                {apiData?.suggest_outline?.["3_body_1_causes"]
                                  ?.supporting_idea_2?.chu_de ||
                                  "Quest for personal fulfillment, better work-life balance, and evolving values."}
                              </p>
                              <p className="mb-2 text-[#374151]">
                                • <strong>Ví dụ cụ thể:</strong>{" "}
                                {apiData?.suggest_outline?.["3_body_1_causes"]
                                  ?.supporting_idea_2?.vi_du_cu_the ||
                                  "Many professionals, after years in high-pressure corporate environments, might transition to non-profit work or entrepreneurship, seeking greater meaning or flexibility, as seen with former bankers becoming social entrepreneurs."}
                              </p>
                              <p className="mb-2 text-[#374151]">
                                • <strong>Development:</strong>{" "}
                                {apiData?.suggest_outline?.["3_body_1_causes"]
                                  ?.supporting_idea_2?.development ||
                                  "This pursuit of job satisfaction and a healthier lifestyle often outweighs the stability of a long-term career, prompting a change."}
                              </p>
                            </div>
                          </div>
                        )}
                            ...
                            <div className="p-3 rounded-md border border-orange-100 text-xs text-orange-700 bg-[#f9fafb]">
                              ...
                              <p className="mb-2 text-[#374151]">
                                ...
                                {apiData?.suggest_outline?.[
                                  ...
                                  "While this trend might present initial challenges, I contend that the increasing prevalence of career changes brings significant benefits to societal development."}
                              </p>
                            </div>
                            ...
                            <div className="p-3 rounded-md border border-red-100 text-xs bg-[#f9fafb] text-[#374151]">
                              ...
                              <p className="mb-2">
                                ...
                                {apiData?.suggest_outline?.[
                                  ...
                                  "Enhanced workforce adaptability and skill diversification."}
                              </p>
                              <p className="mb-2">
                                • <strong>Ví dụ cụ thể:</strong>{" "}
                                {apiData?.suggest_outline?.[
                                  ...
                                  "When individuals move between sectors, they bring diverse perspectives and skill sets, fostering innovation. For example, a former teacher entering the tech industry might introduce novel educational software solutions."}
                              </p>
                              <p className="mb-2">
                                • <strong>Development:</strong>{" "}
                                {apiData?.suggest_outline?.[
                                  ...
                                  "This cross-pollination of ideas and expertise makes the workforce more resilient and dynamic, better equipped to respond to economic shifts."}
                              </p>
                            </div>
                            ...
                            <div className="p-3 rounded-md border border-indigo-100 text-xs bg-[#f9fafb] text-[#374151]">
                              ...
                              <p className="mb-2">
                                ...
                                {apiData?.suggest_outline?.[
                                  ...
                                  "Increased individual job satisfaction and overall productivity."}
                              </p>
                              <p className="mb-2">
                                • <strong>Ví dụ cụ thể:</strong>{" "}
                                {apiData?.suggest_outline?.[
                                  ...
                                  "People who are genuinely passionate about their work are more likely to be productive and engaged. A person who switches from a dissatisfying job to a fulfilling one, like a lawyer becoming a chef, often experiences higher morale and contributes more effectively to their new field."}
                              </p>
                              <p className="mb-2">
                                • <strong>Development:</strong>{" "}
                                {apiData?.suggest_outline?.[
                                  ...
                                  "This leads to a more motivated and efficient workforce, ultimately boosting economic output and societal well-being."}
                              </p>
                            </div>
                          </div>
                        )}
                    ...
                    <AccordionContent className="p-3 bg-white">
                      <div className="mt-3 space-y-3">
                        <div className="p-3 bg-[#f9fafb] rounded-md border border-gray-100 text-xs">
                          ...
                          <p className="mb-2 text-[#374151]">
                            {apiData?.suggest_outline?.["5_conclusion"]
                              ?.huong_dan ||
                              "Kết bài 2 câu – summary + recommendation"}
                          </p>
                        </div>
                        ...
                        <div className="p-3 rounded-md border border-blue-100 text-xs bg-[#f9fafb]">
                          ...
                          <p className="mb-2 text-[#374151]">
                            • <strong>Mục đích:</strong>{" "}
                            {apiData?.suggest_outline?.["5_conclusion"]
                              ?.cau_1_summary?.muc_dich ||
                              "Tóm tắt cả 2 phần body và main topic, không nêu quan điểm mới"}
                          </p>
                          <p className="mb-2 text-[#374151]">
                            • <strong>Ví dụ:</strong>{" "}
                            {apiData?.suggest_outline?.["5_conclusion"]
                              ?.cau_1_summary?.vi_du ||
                              "In conclusion, the growing phenomenon of career changes is driven by both external forces like technological disruption and internal desires for personal fulfillment."}
                          </p>
                        </div>

                        <div className="p-3 bg-[#f9fafb] rounded-md border border-emerald-100 text-xs">
                          <p className="mb-2 font-medium text-[#1fb2aa]">
                            Câu 2 – Final Recommendation
                          </p>
                          <p className="mb-2 text-[#374151]">
                            • <strong>Mục đích:</strong>{" "}
                            {apiData?.suggest_outline?.["5_conclusion"]
                              ?.cau_2_final?.muc_dich ||
                              "Final recommendation về giải pháp hoặc quan điểm bền vững"}
                          </p>
                          <p className="mb-2 text-[#374151]">
                            • <strong>Ví dụ:</strong>{" "}
                            {apiData?.suggest_outline?.["5_conclusion"]
                              ?.cau_2_final?.vi_du ||
                              "Despite potential initial disruptions, this flexibility is largely beneficial, fostering a more adaptable, innovative, and satisfied society."}
                          </p>
                        </div>
                      </div>
                    </AccordionContent>
              ...
              {isLoadingTopicAnalysis ? (
                ...
                <div className="flex flex-col justify-center items-center h-full w-full bg-gradient-to-b from-gray-50 to-white border border-gray-200 rounded-lg p-8 shadow-sm min-h-[350px]">
                  ...
                  <p className="text-gray-700 font-medium text-base mb-2 text-center">
                    Click to explore detailed analysis and outline!
                  </p>
                        ...
                        {isLoading ? (
                          ...
                          <div className="space-y-3">
                            <div className="p-3 rounded-md border border-gray-100 bg-[#f9fafb]">
                              <p className="text-xs font-medium text-[#1fb2aa] mb-2">
                                Bối cảnh – Lý do:
                              </p>
                              <p className="text-xs text-[#374151]">
                                {apiData?.analyze_question?.[
                                  "1_highlight_keywords"
                                ]?.boi_canh_ly_do || "Loading..."}
                              </p>
                            </div>
                            <div className="p-3 rounded-md border border-gray-100 bg-[#f9fafb]">
                              <p className="text-xs font-medium text-[#1fb2aa] mb-2">
                        ...
                        {isLoading ? (
                          ...
                          <div className="space-y-3">
                            <div className="p-3 rounded-md border border-gray-100 bg-[#f9fafb]">
                              ...
                              <p className="text-xs text-[#374151]">
                                {apiData?.analyze_question?.[
                                  "2_identify_essay_type"
                                ]?.essay_type || "Loading..."}
                              </p>
                            </div>
                            <div className="p-3 rounded-md border border-gray-100 bg-[#f9fafb]">
                              <p className="text-xs font-medium text-[#1fb2aa] mb-2">
                                Tips for Band 6.5+ (dưới từng tiêu chí chấm
                                điểm):
                              </p>
                            </div>
                            <div className="p-3 rounded-md border border-gray-100 bg-[#f9fafb]">
                              ...
                              <p className="text-xs text-[#374151]">
                                {apiData?.analyze_question?.[
                                  "2_identify_essay_type"
                                ]?.tips_chi_tiet?.task_response || "Loading..."}
                              </p>
                            </div>
                            <div className="p-3 rounded-md border border-gray-100 bg-[#f9fafb]">
                              <p className="text-xs font-medium text-[#1fb2aa] mb-2">
                              ...
                              <p className="text-xs text-[#374151]">
                                {apiData?.analyze_question?.[
                                  "2_identify_essay_type"
                                ]?.tips_chi_tiet?.coherence_cohesion ||
                                  "Loading..."}
                              </p>
                            </div>
                            <div className="p-3 rounded-md border border-gray-100 bg-[#f9fafb]">
                              ...
                              <p className="text-xs text-[#374151]">
                                {apiData?.analyze_question?.[
                                  "2_identify_essay_type"
                                ]?.tips_chi_tiet?.lexical_resource ||
                                  "Loading..."}
                              </p>
                            </div>
                            <div className="p-3 rounded-md border border-gray-100 bg-[#f9fafb]">
                              ...
                              <p className="text-xs text-[#374151]">
                                {apiData?.analyze_question?.[
                                  "2_identify_essay_type"
                                ]?.tips_chi_tiet?.grammatical_range ||
                                  "Loading..."}
                              </p>
                            </div>
                          </div>
                    ...
                    >
                      ...
                      <AccordionContent className="p-3 bg-white">
                        {isLoading ? (
                          ...
                          <div className="space-y-3">
                            {apiData?.analyze_question?.["4_jobs_to_done"]?.map(
                              (task, index) => (
                                <div
                                  key={index}
                        ...
                        {isLoading ? (
                          ...
                          <div className="space-y-3">
                            <div className="p-3 rounded-md border border-gray-100 bg-[#f9fafb]">
                              ...
                              <p className="text-xs text-[#374151]">
                                {apiData?.analyze_question?.[
                                  "5_suggested_viewpoint"
                                ]?.quan_diem_goi_y || "Loading..."}
                              </p>
                            </div>
                            <div className="p-3 rounded-md border border-gray-100 bg-[#f9fafb]">
                              <p className="text-xs font-medium text-[#1fb2aa] mb-2">
...
function ResourcesSection({
  ...
  const vocabularyWords = allVocabulary.flatMap((category) =>
    category.words
      .filter((word: VocabularyWord) =>
        ["N", "V", "Adj", "Adv"].includes(word.partOfSpeech)
      )
        ...
        <TabsContent value="vocabulary" className="p-0 min-h-[200px]">
          {!showWordBank ? (
            <div className="flex flex-col justify-center items-center h-full w-full bg-gradient-to-b from-gray-50 to-white border border-gray-200 rounded-lg p-8 shadow-sm min-h-[200px]">
              ...
              <p className="text-gray-700 font-medium text-base mb-2 text-center">
                Click to explore helpful vocabulary!
              </p>
              <p className="text-primary font-medium text-sm text-center">
                Build your writing skills with relevant words. 😉
              </p>
            </div>
          ) : (
        ...
        <TabsContent value="phrases" className="p-0 min-h-[200px]">
          {!showWordBank ? (
            <div className="flex flex-col justify-center items-center h-full w-full bg-gradient-to-b from-gray-50 to-white border border-gray-200 rounded-lg p-8 shadow-sm min-h-[200px]">
              ...
              <p className="text-gray-700 font-medium text-base mb-2 text-center">
                Click to explore useful collocations!
              </p>
              <p className="text-primary font-medium text-sm text-center">
  ...
  return (
    <div className="p-4">
      ...
      <div className="flex flex-col lg:flex-row lg:space-x-4">
        ...
        >
          <OutlineSection testType={testType} topic={topic} />
        </div>
      </div>
      ...
      <ResourcesSection testType={testType} topic={topic} />
      ...
      <AlertDialog open={showExitDialog} onOpenChange={setShowExitDialog}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Bạn có chắc chắn muốn thoát khỏi quá trình làm bài? Tiến trình làm
              bài của bạn sẽ không được lưu lại.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
      ...
      <AlertDialog open={showTimeUpDialog} onOpenChange={setShowTimeUpDialog}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Your allocated time for this essay has ended. Would you like to
              submit your work now or continue writing?
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
      ...
      <AlertDialog open={showErrorDialog} onOpenChange={setShowErrorDialog}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Word limit requirement not met. Your essay should be between 50
              and 500 words.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
